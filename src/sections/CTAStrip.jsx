...
export default function CTAStrip() {
  const whatsappMsg = encodeURIComponent('नमस्ते पंडित जी, निःशुल्क परामर्श लेना है।')
    ...
    <section className="py-16 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#faedd0] via-[#f3dfb7] to-[#f8e7c5]">
        <motion.div
          ...
          className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(212,175,55,0.2)_0%,transparent_65%)]"
        />
      </div>
      ...
      {[...Array(8)].map((_, i) => (
        <motion.div
          key={i}
          className="absolute text-gold-500/30 text-lg"
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              ...
              className="btn-whatsapp text-white font-sans font-bold text-base px-8 py-4 inline-flex items-center gap-3"
            >
            ...
            <a
              ...
              className="btn-outline-gold font-sans font-bold text-base px-8 py-4 inline-flex items-center gap-2"
            >
              📝 {ctaStrip.cta}
            </a>
          </div>
